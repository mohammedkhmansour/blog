        ...
        <ul class="pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
                    <a href="#" class="page-link" aria-hidden="true"><i class="fas fa-angle-double-left"></i></a>
                </li>
            @else
                <li class="page-item">
            ...
            @else
                <li class="page-item disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
                    <a href="#" class="page-link" aria-hidden="true"><i class="fas fa-angle-double-right"></i></a>
                </li>
            @endif
        </ul>
    </nav>
